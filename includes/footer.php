            ...
            <div class="container">
              ...
              <div class="row">
                <div class="col l6 s12">
                  ...
                  <p class="grey-text text-lighten-4"><i class="material-icons">email</i><br>contato@lucaspedrowd.com.br</p>
                  <p class="grey-text text-lighten-4"><i class="material-icons">perm_phone_msg</i><br>+55 (21) 98179-2703</p>
                </div>
